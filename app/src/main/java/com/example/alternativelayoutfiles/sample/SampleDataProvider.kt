package com.example.alternativelayoutfiles.sample

import com.example.alternativelayoutfiles.model.CityDataItem
import java.util.*

object SampleDataProvider {
    var cityDataItemList: MutableList<CityDataItem> = ArrayList()
    var dataItemMap: MutableMap<String?, CityDataItem> = mutableMapOf()

    private fun addItem(cityDataItem: CityDataItem) {
        cityDataItemList.add(cityDataItem)
        dataItemMap.put(cityDataItem.cityId, cityDataItem)
    }
    ...
    init {
        ...
        addItem(
            CityDataItem(
                ...
                "Punjab",
                3203846,
                "Faisalabad is a city in eastern Punjab. It is the industrial hub of Pakistan with the highest number of industrial units located here. As the area is surrounded by the Chenab river, various agricultural products are produced here including cotton, wheat, sugarcane, different fruits and vegetables.",
                "faisalabad.jpg"
            )
        )
        addItem(
            CityDataItem(
                ...
                "Punjab",
                2098231,
                "Rawalpindi is a city located in the Potohar region of Punjab. It is called the twin city of Islamabad as they are located side by side. It has an area of 259 square km and a population of about 320.000.",
                "rawalpindi.jpg"
            )
        )
        addItem(
        ...
        addItem(
            CityDataItem(
                ...
                "Punjab",
                762001,
                "Founded in 1748, Bahawalpur was the capital of the former princely state of Bahawalpur, ruled by ruling Abbasi family of Nawabs until 1955. The Nawabs left a rich architectural legacy, and Bahawalpur is now known for its monuments dating from that period.",
                "bahawalpur.jpg"
            )
        )
        addItem(
            CityDataItem(
                ...
                "Punjab",
                659005,
                "Sargodha was established by the British as a canal-colony in 1903, and was initially spelt Sargoda. Sargodha was badly affected by an outbreak of the plague in 1903, and experienced a milder outbreak in 1904.",
                "sargodha.jpg"
            )
        )
        addItem(
